...
def main(args):
    ...
    args.distributed = args.world_size > 1 or args.local_rank != -1
    if args.distributed:
    ...
    if args.distributed:
        ...
        model_without_ddp = model  # 未使用分布式时，直接使用原模型

    model.to(device)



    # Freeze encoder layers (e.g., ViT backbone) and other unchanged parts    new
    for name, param in model_without_ddp.named_parameters():
        if not name.startswith("predict_head") and not name.startswith("global_classifier"):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # saving checkpoint
        if args.output_dir and (epoch % 2 == 0 and epoch != 0 or epoch + 1 == args.epochs):
            misc.save_model(
...
if __name__ == '__main__':
    ...
    main(args)
# # 手动设置参数以完成简单训练测试，方便调试
#     args = get_args_parser().parse_args([])
#     args.world_size = 1
#     args.local_rank = -1
#     args.resume = r"D:\study_data\study\classes\3up\new_shot_class\homework\code\MIL-VIT\IML-ViT-main\IML-ViT-main\checkpoints\iml-vit_checkpoint.pth"
#     args.batch_size = 1
#     args.test_size = 1
#     args.data_path = r"D:\study_data\study\classes\3up\new_shot_class\homework\code\MIL-VIT\IML-ViT-main\IML-ViT-main\image_casia_train3\dataset.json"
#     args.epochs = 10
#     args.lr = 1e-4
#     args.min_lr = 5e-7
#     args.weight_decay = 0.05
#     args.edge_lambda = 20
#     args.predict_head_norm = "BN"
#     args.vit_pretrain_path = r"D:\study_data\study\classes\3up\new_shot_class\homework\code\MIL-VIT\IML-ViT-main\IML-ViT-main\pretrained-weights\mae_pretrain_vit_base.pth"
#     args.test_data_path = r"D:\study_data\study\classes\3up\new_shot_class\homework\code\MIL-VIT\IML-ViT-main\IML-ViT-main\images\sample_iml_dataset"
#     args.warmup_epochs = 4
#     args.output_dir = r".\output_dir"
#     args.log_dir = r".\output_dir"
#     args.accum_iter = 8
#     args.seed = 42
#     args.test_period = 1
#     args.num_workers = 4
